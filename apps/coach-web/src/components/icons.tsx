...
const paths: Record<IconName, React.ReactNode> = {
  ...
  ai: (
    <>
      <path d="M12 3a4 4 0 0 0-4 4v1a4 4 0 0 0-1 7.87V17a4 4 0 0 0 7 2.65A4 4 0 0 0 17 13V7a4 4 0 0 0-5-4Z" />
      <path d="M9 8h.01M15 8h.01M9.5 13a4 4 0 0 0 5 0" />
    </>
  ),
